...
/* CoCo text screen is only 32 columns, so render one character per module.
   Swap QR_ON for a solid-block glyph from your character set for a scannable
   code (text mode can't show a full code without scrolling). */
#define QR_ON  '#'
#define QR_OFF ' '
